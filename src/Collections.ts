...
/**
    ...
    */
export class OrderedSpriteList<T extends Sprite> extends DoublyLinkedList<T>
{
...
export class ZOrderedSpriteList<T extends Sprite> extends OrderedSpriteList<T>
{
    constructor()
    {
