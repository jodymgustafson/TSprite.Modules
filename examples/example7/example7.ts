...
import {CanvasMultiRectCollisionChecker} from  "../../src/CanvasMultiRectCollisionChecker";
...
class Example4App extends ExampleApp
{
    ...
    constructor()
    {
        super("Collision Detection with Multiple Areas");
    ...
    public start()
    {
        ...
        img.onload = () =>
        {
            ...
            this.sprite1.collisionChecker = new CanvasMultiRectCollisionChecker(this.sprite1, [
                new Rectangle(32, 16).moveTo(0, 8),
                new Rectangle(16, 32).moveTo(8, 0)
            ]);
            ...
            this.sprite2.collisionChecker = new CanvasMultiRectCollisionChecker(this.sprite2, [
                new Rectangle(32, 16).moveTo(0, 8),
                new Rectangle(16, 32).moveTo(8, 0)
            ]);
